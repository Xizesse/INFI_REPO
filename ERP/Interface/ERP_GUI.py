...
class ShopFloorStatisticsWindow:
    def __init__(self, master):
        ...
        initial_orders_data = DB.get_orders()
        ...
        initial_production_plan_data = DB.get_production_plan()
        ...
        initial_purchasing_plan_data = DB.get_purchasing_plan()
    ...
    def update_purchasing_plan_data(self):
        purchasing_plan = DB.get_purchasing_plan()  # Assuming this returns a list of dictionaries
